...
- 🏛️ **Hero sekce s odpočtem:** Živý odpočet zbývajícího času do komunálních voleb (9. – 10. října 2026) s animovaným nadpisem a výdominantním logem.
- 👥 **Kandidátní listina (#kandidatka):** Přehledná mřížka 21 kandidátů v čele se lídryní **Soňou Peprlovou** a **Petrem Křížem**, včetně věku, povolání, politické příslušnosti a detailních medailonků.
...
- **Vanilla CSS3** – Moderní tmavý designový systém, CSS Grid, Flexbox, custom variables, keyframe animace a glassmorphism.
...
- **Google Fonts** – Fonty *Noto Sans Georgian*, *Syne* a *Montserrat*.
...
```text
za-jaromerice/
├── index.html        # Hlavní HTML struktura webu
...
├── assets/           # Obrázky, fotky kandidátů a grafické podklady
...
1. Klonovat repozitář:
   ...
   ```
2. Otevřít soubor `index.html` v libovolném webovém prohlížeči (např. dvojklikem nebo pomocí rozšíření *Live Server* ve VS Code).
